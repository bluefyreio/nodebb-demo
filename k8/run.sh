...
# set up the Azure storage class
az storage account create --resource-group MC_sandbox01_nodebbcluster01_eastus --name nodebbcluster01storage --location eastus --sku Standard_LRS    
